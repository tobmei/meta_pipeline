...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Superkingdom") + ylab("Frequenz")  
...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Phylum") + ylab("Frequenz")  
...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Class") + ylab("Frequenz") 
...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Order") + ylab("Frequenz") + ggtitle("supercooler plot")
...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Family") + ylab("Frequenz") + ggtitle("supercooler plot")
...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Genus") + ylab("Frequenz") + ggtitle("supercooler plot")
...
plot + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + xlab("Species") + ylab("Frequenz") + ggtitle("supercooler plot")
dev.off()


pdf(paste0(out2,'_pfams.pdf'))
list2.ord <- list2[order(-list2$count),]
plot <- ggplot(list2.ord[1:10,], aes(x=factor(pfam, levels=unique(pfam)), y=count)) + geom_bar(stat='identity') 
